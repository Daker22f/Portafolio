...
export function PortraitMorph({ srcA, srcB, alt, className }: PortraitMorphProps): ReactNode {
  ...
  useEffect(() => {
    ...
    const onPointerMove = (e: PointerEvent) => {
      ...
      if (lastPointer && performance.now() - lastPointer.t < 80 && progressRef.current < 0.15) {
