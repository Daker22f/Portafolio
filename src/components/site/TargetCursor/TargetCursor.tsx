...
const TargetCursor = ({
  ...
  useEffect(() => {
    ...
    const tickerFn = () => {
      ...
      if (!positions || !cursorRef.current || !cornersRef.current) {
        return;
      }
      ...
      corners.forEach((corner, i) => {
        ...
        const cornerPosition = positions[i];
        if (!cornerPosition) return;

        const targetX = cornerPosition.x - cursorX;
        const targetY = cornerPosition.y - cursorY;
    ...
    const enterHandler = (e: MouseEvent) => {
      ...
      corners.forEach((corner, i) => {
        const targetPosition = targetCornerPositions[i];
